...
description: RQ+문헌→실험 설계·코드·실행(가능 시). MOCK 명시. 파이프라인 4단계.
...
(환각/MOCK 후속 처리/보고 톤은 `_common.md` 참조)

## 호출자 컨벤션
최종 응답 3-4문장: "04_experiments/ 구축 완료. 실험 N개." / "실행 상태: 완료/부분/mock(사유)" / "주요 결과(있다면)" / "주의사항(있다면)"
