...
### Exp3 비교 — RQ3 (counterfactual ablation C0~C5)
...
| C5 text-free InfoNCE | 0.4994 | −0.276 | 0.1327 | −0.391 |
...
- BioCLIP ViT-B/16과의 비교는 미수행. OpenCLIP ViT-L/14 비교는 추가 완료 (Cross-Model Comparison 섹션 참조) — 동일 Aves 단일 도메인 내 정성적 패턴 일관성은 확인됐으나, 다중 분류군·다중 데이터셋에 대한 일반화는 여전히 Exp4(future work)에서 검증 필요.
